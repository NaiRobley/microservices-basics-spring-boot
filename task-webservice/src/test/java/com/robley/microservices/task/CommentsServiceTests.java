package com.robley.microservices.task;
...
import com.robley.microservices.task.apis.CommentsService;
import com.robley.microservices.task.model.CommentCollectionResource;
import com.robley.microservices.task.oauth2.config.OAuth2ClientTestConfiguration;
import com.robley.microservices.task.oauth2.security.WithMockOAuth2Token;
...
@AutoConfigureStubRunner(ids = { "robley:basic-comments-webservice-stubs:+:stubs:9083" }, workOffline = true)
@DirtiesContext
